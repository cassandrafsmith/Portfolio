        ...
        <div className='about-section' id='about'>  
          ...
          <div className='about-me-letter'>
            ...
            <p className='section-copy'> 
              ...
              A couple of things that I am currently learning more about are DevOps methodologies and how they 
              can be used to increase collaboration in teams, and also inclusive UI/UX design  
              and how it is best used to create digital experiences that are fun and accessible for all.
            </p>
            <p className='section-copy'>             
